...
var parseToMd = function parseToMd(layerName, layer, directoryPath) {
  ...
  switch (layerName) {
    ...
    case "list-ordered":
      ...
      .split(/[\s,]+[\s,]/).forEach(function (listItem, key, content) {
        md += "".concat(key + 1, ". ").concat(listItem, "\n").concat(Object.is(content.length - 1, key) ? "\n" : "");
      });
      break;
...
function () {
  ...
  return function getMdContent(_x, _x2, _x3) {
...
/* harmony import */ var _parse_layers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./parse-layers */ "./src/parse-layers.js");
